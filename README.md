...
全站主題色以 **星辰藍 (Starry Blue)** 與 **星光金/黃 (Starlight Gold/Yellow)** 為核心，搭配深邃的夜空藍與背景深灰：

| 用途 | 色碼 / 設計 | 應用實例 |
|------|------|------|
| **星辰藍 (Starry Blue)** | `#7298c6` | 連結主色、互動狀態、科技感飾線、動畫徽章細框 |
| **星光金/黃 (Starlight Gold/Yellow)** | `#f2d88f` | Hover 互動狀態、Back to Top 按鈕 Hover |
| **夜空深藍 (Night Sky Deep Blue)** | `#121b3c` | 動畫徽章填色背景、部分區塊背景/邊框 |
| **科技暗藍 (Tech Dark Blue)** | `#1e305a` | 動畫徽章外層粗框 |
| **背景深灰 (Background Dark Gray)** | `#2e2e2e` | 網頁主背景、毛玻璃導覽列背景、下拉選單背景 |
| **主文字灰白 (Primary Text)** | `#e4e4e4` | 網頁主體內容文字 |
